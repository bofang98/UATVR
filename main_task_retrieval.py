...
def get_args(description='CLIP4Clip on Retrieval Task'):
    ...
    parser.add_argument("--n_video_embeddings", default=7, type=int, help="number of sampling video probabilistic embeddings")
    parser.add_argument("--n_text_embeddings", default=7, type=int, help="number of sampling text probabilistic embeddings")
...
def _run_on_single_gpu(model, batch_list_t, batch_list_v, batch_sequence_output_list, batch_visual_output_list):
    ...
    for idx1, b1 in enumerate(batch_list_t):
        ...
        for idx2, b2 in enumerate(batch_list_v):
            ...
            b1b2_logits, *_tmp = model.get_similarity_logits(sequence_output, text_token, visual_output, input_mask, video_mask,
    ...
    with torch.no_grad():
        ...
        for bid, batch in enumerate(test_dataloader):
            ...
            if multi_sentence_:
                ...
                batch_sequence_output_list.append((sequence_output, text_token,))
                ...
                sequence_output, text_token, visual_output = model.get_sequence_visual_output(input_ids, segment_ids, input_mask, video, video_mask)
...
def main():
    ...
    if args.do_train:
        ...
        if args.local_rank == 0:
            model = load_model(-1, args, n_gpu, device, model_file='path-to-checkpoint.pt')
            eval_epoch(args, model, test_dataloader, device, n_gpu)     
